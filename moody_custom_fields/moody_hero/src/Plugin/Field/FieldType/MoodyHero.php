...
namespace Drupal\moody_hero\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'moody_hero' field type.
 *
 * @FieldType(
 *   id = "moody_hero",
 ...
 * )
 */
class MoodyHero extends FieldItemBase {
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    ...
    $properties['credit'] = DataDefinition::create('string')
      ...
      ->setRequired(FALSE);
    $properties['text_position'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('Text Position'))
      ->setRequired(FALSE);
    $properties['text_color'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('Text Color'))
      ->setRequired(FALSE);
    $properties['overlay'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('Overlay'))
      ->setRequired(FALSE);
