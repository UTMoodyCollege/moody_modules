 ...
 * @FieldFormatter(
 *   id = "moody_hero_8",
 *   label = @Translation("Style 8: Moody homepage design"),
 *   field_types = {
 *     "moody_hero"
 *   }
 * )
 */
class MoodyHeroStyle8Formatter extends MoodyHeroFormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $small_image_style_name = 'utexas_image_style_900w';
    ...
    $elements['#attached']['library'][] = 'moody_hero/hero-style-8';
    return $elements;
  }
