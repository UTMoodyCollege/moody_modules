 ...
 * @FieldFormatter(
 *   id = "moody_hero_7",
 *   label = @Translation("Style 7: Moody homepage design"),
 *   field_types = {
 *     "moody_hero"
 *   }
 * )
 */
class MoodyHeroStyle7Formatter extends MoodyHeroFormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $elements['#attached']['library'][] = 'moody_hero/hero-style-7';
    return $elements;
  }
