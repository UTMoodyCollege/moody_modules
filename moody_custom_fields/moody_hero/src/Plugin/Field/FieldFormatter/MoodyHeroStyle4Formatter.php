 ...
 * )
 */
class MoodyHeroStyle4Formatter extends MoodyHeroFormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $responsive_image_style_name = 'moody_responsive_image_hi';
    ...
    $elements['#attached']['library'][] = 'moody_hero/hero-style-4';
    return $elements;
  }
