...
namespace Drupal\moody_contact_info\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'moody_contact_info_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "moody_contact_info_formatter",
 *   label = @Translation("Moody contact info formatter"),
 *   field_types = {
 *     "moody_contact_info"
 *   }
 * )
 */
class MoodyContactInfoFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
