 ...
 *
 * @FieldFormatter(
 *   id = "moody_flex_grid_formatter2",
 *   label = @Translation("Circular Style"),
 *   field_types = {
 *     "moody_flex_grid"
 *   }
 * )
 */
class MoodyFlexGridFormatter2 extends FormatterBase implements ContainerFactoryPluginInterface {
  /**
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[] = [
        '#theme' => 'moody_flex_grid_circular',
      ...
      $elements['#attributes']['class'][] = 'moody-flex-grid-wrapper circular-display';
    }
