 ...
 *
 * @FieldFormatter(
 *   id = "moody_flex_grid_formatter",
 *   label = @Translation("Standard styling"),
 *   field_types = {
 *     "moody_flex_grid"
 *   }
 * )
 */
class MoodyFlexGridFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  /**
