 ...
 *
 * @FieldFormatter(
 *   id = "moody_flex_grid_formatter4",
 *   label = @Translation("Rectangular Style"),
 *   field_types = {
 *     "moody_flex_grid"
 *   }
 * )
 */
class MoodyFlexGridFormatter4 extends FormatterBase implements ContainerFactoryPluginInterface {
  /**
