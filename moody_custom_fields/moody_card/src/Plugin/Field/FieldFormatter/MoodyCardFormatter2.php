 ...
 *
 * @FieldFormatter(
 *   id = "moody_card_formatter2",
 *   label = @Translation("Moody Card Formatter (Homepage People)"),
 *   field_types = {
 *     "moody_card"
 *   }
 * )
 */
class MoodyCardFormatter2 extends MoodyCardFormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      $cta = static::buildCta($item->link_uri, $item->link_title, $item->link_options, ['ut-btn']);
      $image_render_array = [];
