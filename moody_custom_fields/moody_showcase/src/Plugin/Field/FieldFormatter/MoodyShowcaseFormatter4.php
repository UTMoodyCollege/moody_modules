...
/**
 * Plugin implementation of the 'moody_showcase_formatter4' formatter.
 *
 * @FieldFormatter(
 *   id = "moody_showcase_formatter4",
 *   label = @Translation("Moody showcase formatter4"),
 *   field_types = {
 *     "moody_showcase"
 *   }
 * )
 */
class MoodyShowcaseFormatter4 extends MoodyShowcaseFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements['#items'][$delta]->_attributes = [
        'class' => ['moody-showcase-default-style', 'moody-showcase-33-66'],
      ];
