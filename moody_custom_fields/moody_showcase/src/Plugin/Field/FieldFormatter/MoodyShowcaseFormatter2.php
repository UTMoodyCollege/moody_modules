...
/**
 * Plugin implementation of the 'moody_showcase_formatter2' formatter.
 *
 * @FieldFormatter(
 *   id = "moody_showcase_formatter2",
 *   label = @Translation("Moody showcase formatter2"),
 *   field_types = {
 *     "moody_showcase"
 *   }
 * )
 */
class MoodyShowcaseFormatter2 extends MoodyShowcaseFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements['#items'][$delta]->_attributes = [
        'class' => ['moody-showcase-default-style', 'moody-showcase-66-33'],
      ];
