...
namespace Drupal\moody_promotion\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'moody_promotion' field type.
 *
 * @FieldType(
 *   id = "moody_promotion",
 *   label = @Translation("Moody promotion"),
 *   description = @Translation("Featured promo with image, copy and link fields"),
 *   default_widget = "moody_promotion_widget",
 *   default_formatter = "moody_promotion_formatter"
 * )
 */
class MoodyPromotion extends FieldItemBase {
