...
namespace Drupal\moody_faq\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'moody_faq_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "moody_faq_formatter",
 *   label = @Translation("Moody faq formatter"),
 *   field_types = {
 *     "moody_faq"
 *   }
 * )
 */
class MoodyFaqDefaultFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
