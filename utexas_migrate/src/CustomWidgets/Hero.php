...
class Hero {
  ...
  public static function createBlockDefinition(array $data) {
    $block_definition = [
      ...
      'field_block_moody_hero' => $data['block_data'],
      'reusable' => FALSE,
    ];
  ...
  public static function getRawSourceData($instance, $source_nid) {
    ...
    foreach ($source_data as $delta => $item) {
      $prepared[$delta] = [
        ...
        'heading' => $item->field_custom_hero_photo_caption,
  ...
  protected static function massageFieldData(array $source) {
    ...
    foreach ($source as $delta => $instance) {
      ...
      if (!empty($instance['heading'])) {
        $destination[$delta]['heading'] = $instance['heading'];
      }
      ...
      $style_map = [
        'default-center' => 'moody_hero',
        'hero-style-1-left' => 'moody_hero_1_left',
        'hero-style-1-center' => 'moody_hero_1',
        'hero-style-1-right' => 'moody_hero_1_right',
        'hero-style-2-left' => 'moody_hero_2_left',
        'hero-style-2-center' => 'moody_hero_2',
        'hero-style-2-right' => 'moody_hero_2_right',
        'hero-style-3-left' => 'moody_hero_3_left',
        'hero-style-3-center' => 'moody_hero_3',
        'hero-style-3-right' => 'moody_hero_3_right',
        'hero-style-4-left' => 'moody_hero_4',
        'hero-style-4-center' => 'moody_hero_4',
        'hero-style-4-right' => 'moody_hero_4',
        'hero-style-5-left' => 'moody_hero_5_left',
        'hero-style-5-center' => 'moody_hero_5',
        'hero-style-5-right' => 'moody_hero_5_right',
        'hero-style-6-left' => 'moody_hero_5_left',
        'hero-style-6-center' => 'moody_hero_5',
        'hero-style-6-right' => 'moody_hero_5_right',
        'hero-style-7-left' => 'moody_hero_5_left',
        'hero-style-7-center' => 'moody_hero_5',
        'hero-style-7-right' => 'moody_hero_5_right',
        'hero-style-8-left' => 'moody_hero_5_left',
        'hero-style-8-center' => 'moody_hero_5',
        'hero-style-8-right' => 'moody_hero_5_right',
        'hero-style-9-left' => 'moody_hero_5_left',
        'hero-style-9-center' => 'moody_hero_5',
        'hero-style-9-right' => 'moody_hero_5_right',
      ];
